...
interface Props {
    ...
    onSubmit: (values: GroqFormValues, credentialId: string | null) => void;
    defaultValues?: Partial<GroqFormValues>;
    defaultCredentialId?: string | null;
};

export const GroqDialog = ({ open, onOpenChange, onSubmit, defaultValues = {}, defaultCredentialId = null }: Props) => {
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto w-full
                ...
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Configure the fast AI model and prompts for the Groq node.
                    </DialogDescription>
                </DialogHeader>
                <Form {...form}>
